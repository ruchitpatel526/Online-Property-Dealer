...
$sql = "SELECT * FROM property_info WHERE dealer_id='$dealer_id' && type='Independent House'";
...
while($row = mysql_fetch_assoc($records)){
	...
	if($a == '2'){
		...
		<div style='background-color:black ; height:8% ; width:200px'>
			<h3 style='color:white ; text-align:center ; padding-top:10px'>Independent Houses</h3>
		</div>
		</div>
